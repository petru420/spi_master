...
HD_PWD='C:/Xilinx/training/xilinx_projects/SPI_master/SPI_master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_master_cs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_master_cs.tcl
